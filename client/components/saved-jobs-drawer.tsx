  ...
  return (
    <>
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent side="right" className="w-[350px] sm:w-[450px] p-0 overflow-y-auto">
            ...
            {!isLoading && !error && savedJobs.length > 0 && (
              <div>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-sm font-medium">Saved Jobs</h3>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <div className="space-y-3">
                  {savedJobs.map((job) => (
                    <Card key={job.id} className="w-full p-3 hover:shadow-md transition-shadow">
